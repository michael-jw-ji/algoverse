...
def parse_args():
    ...
    parser.add_argument("--variant", type=str, default=None, help="model variant (e.g., EleutherAI/pythia-70m)")
    parser.add_argument("--batch_size", type=int, help="batch size", default=32)
    parser.add_argument("--ndevices", type=int, help="number of devices", default=1)
    parser.add_argument("--seed", type=int, help="random seed", default=42)
    parser.add_argument("--checkpoint", type=int, help="checkpoint", required=True)
    parser.add_argument(
        "--dataset",
        type=str,
...
if __name__ == "__main__":
    ...
    model = load_model(base_model=opts.model_name, checkpoint=opts.checkpoint) 
